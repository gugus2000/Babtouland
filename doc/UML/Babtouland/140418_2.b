...
!!!189186.php!!!	__construct(in bdd : )

		$this->setBdd($bdd);
!!!189314.php!!!	getBdd()

		return $this->bdd;
!!!189442.php!!!	setBdd(in bdd : )

		$this->bdd=$bdd;
!!!189570.php!!!	get(in attributs : , in operations : )
		...
		return $results;
!!!189698.php!!!	addBy(in variants : , in invariants : )
...
!!!189826.php!!!	deleteBy(in attributs : )
