...
!!!203266.php!!!	name()
		return $this->_name;
!!!203394.php!!!	setName(in name : )
		$this->_name = $name;
		return true;
!!!203522.php!!!	appendToName(in chars : )
		$this->_name .= $chars;
		return true;
!!!203650.php!!!	appendToAttribute(in name : , in chars : )
		...
		$this->_attributes[$name] .= $chars;
		return true;
!!!203778.php!!!	setAttribute(in name : , in value : )
		$this->_attributes[$name] = $value;
		return true;
!!!203906.php!!!	setCodeInfo(in info : )
		$this->_codeInfo = $info;
		$this->_flags = $info['flags'];
		return true;
!!!204034.php!!!	attribute(in name : )
		if (!isset ($this->_attributes[$name])) {
			return null;
		}
		return $this->_attributes[$name];
!!!204162.php!!!	setHadCloseTag()
		$this->_hadCloseTag = true;
!!!204290.php!!!	setParagraphHandled()
		$this->_paragraphHandled = true;
!!!204418.php!!!	paragraphHandled()
		return $this->_paragraphHandled;
!!!204546.php!!!	hadCloseTag()
		return $this->_hadCloseTag;
!!!204674.php!!!	matchesCriterium(in criterium : , in value : )
...
!!!204930.php!!!	lastChildIfText()
		...
		return $ret;
!!!205058.php!!!	findNextAdjentTextNode()
		$ret = null;
		...
		return $ret;
!!!205186.php!!!	findPrevAdjentTextNode()
		$ret = null;
		if (is_null ($this->_parent)) {
			return $ret;
		}
		...
		return $ret;
!!!205314.php!!!	_findPrevAdjentTextNodeHelper()
		...
		return $ret;
!!!205442.php!!!	getFlag(in flag : , in type :  = 'mixed', in default :  = null)
		...
		return $return;
!!!205570.php!!!	setFlag(in name : , in value : )
		$this->_flags[$name] = $value;
		return true;
!!!205698.php!!!	validate(in action :  = 'validate')
...
!!!205826.php!!!	getReplacement(in subcontent : )
		if ($this->_codeInfo['callback_type'] == 'simple_replace' || $this->_codeInfo['callback_type'] == 'simple_replace_single') {
