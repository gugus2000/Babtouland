class StringParser
!!!192386.php!!!	addFilter(in type : , in callback : )
		...
		return true;
!!!192514.php!!!	clearFilters(in type :  = 0)
		switch ($type) {
			case 0:
...
!!!192642.php!!!	parse(in text : )
		...
		$this->_parsing = false;
		return $this->_output;
!!!192770.php!!!	_applyPrefilters(in text : )
		...
		return $text;
!!!192898.php!!!	_applyPostfilters(in text : )
		...
		return $text;
!!!193026.php!!!	_modifyTree()
		return true;
!!!193154.php!!!	_outputTree()
		// this could e.g. call _applyPostfilters
		return true;
!!!193282.php!!!	_reparseAfterCurrentBlock()
		...
		return true;
!!!193410.php!!!	_closeRemainingBlocks()
		// everything closed
		...
		return true;
!!!193538.php!!!	_parserInit()
		$this->_setStatus (0);
!!!193666.php!!!	_setStatus(in status : )
		if ($status != 0) {
			return false;
		}
		...
		$this->_status = $status;
		return true;
!!!193794.php!!!	_handleStatus(in status : , in needle : )
		$this->_appendText ($needle);
		$this->_cpos += strlen ($needle);
		return true;
!!!193922.php!!!	_searchLoop()
		$i = 0;
		while (1) {
...
!!!194562.php!!!	_strDetect(in needles : , in offset : )
		foreach ($needles as $needle) {
			$l = strlen ($needle);
		...
		return false;
!!!194690.php!!!	_pushNode(inout node : )
