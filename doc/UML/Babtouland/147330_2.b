...
!!!253314.php!!!	name()
		return $this->_name;
!!!253442.php!!!	setName(in name : )
		$this->_name = $name;
		return true;
!!!253570.php!!!	appendToName(in chars : )
		$this->_name .= $chars;
		return true;
!!!253698.php!!!	appendToAttribute(in name : , in chars : )
		...
		$this->_attributes[$name] .= $chars;
		return true;
!!!253826.php!!!	setAttribute(in name : , in value : )
		$this->_attributes[$name] = $value;
		return true;
!!!253954.php!!!	setCodeInfo(in info : )
		$this->_codeInfo = $info;
		$this->_flags = $info['flags'];
		return true;
!!!254082.php!!!	attribute(in name : )
		if (!isset ($this->_attributes[$name])) {
			return null;
		}
		return $this->_attributes[$name];
!!!254210.php!!!	setHadCloseTag()
		$this->_hadCloseTag = true;
!!!254338.php!!!	setParagraphHandled()
		$this->_paragraphHandled = true;
!!!254466.php!!!	paragraphHandled()
		return $this->_paragraphHandled;
!!!254594.php!!!	hadCloseTag()
		return $this->_hadCloseTag;
!!!254722.php!!!	matchesCriterium(in criterium : , in value : )
...
!!!254978.php!!!	lastChildIfText()
		...
		return $ret;
!!!255106.php!!!	findNextAdjentTextNode()
		$ret = null;
		...
		return $ret;
!!!255234.php!!!	findPrevAdjentTextNode()
		$ret = null;
		if (is_null ($this->_parent)) {
			return $ret;
		}
		...
		return $ret;
!!!255362.php!!!	_findPrevAdjentTextNodeHelper()
		...
		return $ret;
!!!255490.php!!!	getFlag(in flag : , in type :  = 'mixed', in default :  = null)
		...
		return $return;
!!!255618.php!!!	setFlag(in name : , in value : )
		$this->_flags[$name] = $value;
		return true;
!!!255746.php!!!	validate(in action :  = 'validate')
...
!!!255874.php!!!	getReplacement(in subcontent : )
		if ($this->_codeInfo['callback_type'] == 'simple_replace' || $this->_codeInfo['callback_type'] == 'simple_replace_single') {
